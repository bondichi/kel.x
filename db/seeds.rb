...
q7 = Question.new(content: {type: "selection", question: "Are there any colours you don't like to wear?", option_type: 'text', options: [["Black and very dark shades", 1], ["White & very pale colours", 2], ["Very bright shades", 3], ["Neutrals / earth tones", 4], ["Pastel shades - pale pink, lilac", 5],["None", 6]]})
q8 = Question.new(content: {type: "selection", question: "How much would you spend on a shirt?", option_type: 'text', options: [["$20-50", 1], ["$50-$100", 2], ["$100-150", 3], ["$150 +", 4]] })
